...
assert(RangeinfoOutput[arraysize].rangecount == 1);
assert(RangeinfoOutput[RangeinfoOutput[arraysize].rangecount].startvalue == 4);
assert(RangeinfoOutputRangeinfoOutput[arraysize].rangecount].endvalue == 5);  
printf("\n\nTest case 2");
