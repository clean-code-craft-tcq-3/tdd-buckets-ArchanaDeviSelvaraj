...
Rangeinfo[2] = detectRangeCountAndPrintDetails(samplesarray,arraysize);
assert(Rangeinfo[0].rangecount == 1);
assert(Rangeinfo[0].startvalue == 4);
assert(Rangeinfo[0].endvalue == 5);  
printf("\n\nTest case 2");
